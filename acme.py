...
try:
    iserror = []
    df = pd.read_excel(r'.\Acme\ReportExcel.xlsx', sheet_name='Header')
    ...
    if language > 0:
        desc = pd.read_excel(r'.\Acme\ReportExcel.xlsx', sheet_name='Description')
        doc = DocxTemplate(r'.\Acme_Rapor_Format_TR.docx')
    else:
        desc = pd.read_excel(r'.\Acme\ReportExcel.xlsx', sheet_name='Description')
        df = pd.read_excel(r'.\Acme\ReportExcel.xlsx', sheet_name='Header')
        doc = DocxTemplate(r'.\Acme\Acme_Rapor_Format_EN.docx')
    ...
    error_file = open(r'.\Acme\error_log.txt','w')
